package com.example.asus.shopdemo.detail;
...
import com.example.asus.shopdemo.RefreshManager;
import com.example.asus.shopdemo.download.DownLoadAcitivity;
import com.example.asus.shopdemo.search.SearchAcitivity;
import com.example.asus.shopdemo.setting.SettingActivity;
import com.example.asus.shopdemo.setting.SettingManager;
import com.example.asus.shopdemo.util.NetWorkUtil;
import com.example.asus.shopdemo.shop.AppInfo;
...
//                intent.putExtra(Intent.EXTRA_TEXT, "分享一个有趣的APP：" + appName
//                         + detailUrl);
